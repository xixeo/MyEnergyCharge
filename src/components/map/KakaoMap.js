...
const KakaoMap = ({ onMapReady, area, subArea }) => {
    ...
    const [currentZoomLevel, setCurrentZoomLevel] = useState(); // 초기 줌 레벨 상태 설정
            ...
            navigator.geolocation.getCurrentPosition((position) => {
               ...
               // 지도 줌 컨트롤을 생성
                ...
                const addPolygons = () => {
                    ...
                    const dataToUse =
                        currentZoomLevel < 11 ? siguData : sidoData;
                    dataToUse.features.forEach((feature) => {
                        getPolycode(feature, map);
                    });
                };
